    ...
    <main>
        ...
        <section class="dashboardpart">
            <div class="wrapper">
                    ...
                    <?php echo form_open('DashboardBusiness2Form'); ?>
                <strong align = "center"><h1>Welcome to Business Dashboard Page</h1></strong>
                <div class = "row">
                <label for="lugar">Conference</label>
                <input type = "text" id = "conferences" name = "conferences" placeholder="Enter the Conference Name" 
                       value=<?php echo $posts->conferences; ?>> 
                </div>
                <div class = "row">
                ...
                <div align = "center">
                <input type = "submit" value = "Update Event" id="submitButton" name = "addConferenceButton">
                </div>
                </form>  
                </div>
        </section>

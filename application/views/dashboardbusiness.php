    ...
    <main>
        ...
        <section class="dashboardpart">
            <div class="wrapper">
                    ...
                    <?php echo form_open('DashboardBusinessForm'); ?>
                ...
                <div class="centertext">
                    <a href="DashboardEventBusinessForm" class="gradient btn">Event</a>
                    <br>
                    <br>
                    <br>
                    <br>
                    <a href="DashboardConferenceBusinessForm" class="gradient btn">Conference</a>
                </div>
            </form>
            </div>
        </section>

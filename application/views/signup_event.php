        ...
        <section class="signuppart">
            <div class="logindetails clearfix">
                ...
                <div class="cbox">
                    ...
                    <form action = "/WDM_project5/index.php/SignupEventForm" method = "post">
                    ...
                    <label for="password">Password<input type="text" placeholder="Enter Password" name = "password"></label>
